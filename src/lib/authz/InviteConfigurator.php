...
class InviteConfigurator extends AuthorizationConfigurator {
    ...
    /**
     *
     * @return array(hostname, port, weight)
     */
    public function getInvitesDBServers() {
        return @$this->cfg['InvitesDBServers'];
    }
     ...
     * @return integer
     */
    public function getInvitesDBKeyExpirationTimeout() {
        return @$this->cfg['InvitesDBKeyExpirationTimeout'];
    }
     ...
     * @return array(hostname, port, weight)
     */
    public function getAuthorizedDBServers() {
        return @$this->cfg['AuthorizedDBServers'];
    }
     ...
     * @return integer
     */
    public function getAuthorizedDBKeyExpirationTimeout() {
        return @$this->cfg['AuthorizedDBKeyExpirationTimeout'];
    }
