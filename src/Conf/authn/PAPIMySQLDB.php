...
use RedIRIS\PoA\Conf\db\GenericMySQLDB;
...
class PAPIMySQLDB extends GenericMySQLDB implements PAPIDB {
    ...
    public function __construct($cfg) {
        ...
        $this->purge_sql   = "DELETE FROM ##PREFIX##".PAPI_DB_TABLE." WHERE `TIMESTAMP` < ";
    ...
    public function purge($gap) {
        return (@mysql_query($this->purge_sql.time(), $this->db)) ? true: false;
    }
