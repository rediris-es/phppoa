...
class PAPIConfigurator extends GenericConfigurator {
     ...
     * @return integer
     */
    public function getDBKeyExpirationTimeout() {
        return @$this->cfg['DBKeyExpirationTimeout'];
    }
    ...
    public function getRedirectType() {
        ...
        case PoAConstants::GPOA_T:
        case "GPoA":
        case "GPOA":
        case "GPOA_T":
        case "GPoA_T":
            return PoAConstants::GPOA_T;
        case PoAConstants::AS_T:
        case "AS":
        case "AS_T":
            return PoAConstants::AS_T;
        }
    }
